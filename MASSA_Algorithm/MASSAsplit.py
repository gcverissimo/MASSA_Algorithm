...
def freq_clusters(
    ...
    if splitting_strategy == "tt":
        ...
        bar_width = 0.2
        fig, ax = plt.subplots(figsize=(10, 6))  # Set the figure size.
        group1 = ax.bar(total_ar-(bar_width*2), percentages_total, bar_width,
                        label='Total',
                        color='black', edgecolor='black')  # Bar plot for the total set.
        group2 = ax.bar(training_ar-(bar_width), percentages_training, bar_width,
                        label='Training set',
                        color='dimgrey', edgecolor='black')  # Bar plot for the training set.
        group3 = ax.bar(test_ar, percentages_test, bar_width,
                        label='Test set',
                        color='lightgrey', edgecolor='black')  # Bar plot for the test set.
        group4 = ax.bar(validation_ar+bar_width, percentages_validation, bar_width,
