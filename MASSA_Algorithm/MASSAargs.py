...
def capture_args():
	...
	optional.add_argument('-l','--linkage_method', type=str, choices=['complete', 'single', 'ward', 'average'], metavar='LINKAGE_METHOD', default='complete', help='The linkage criterion to use. The algorithm will merge the pairs of cluster that minimize this criterion. Options = complete, single, ward, average. Default = complete')
